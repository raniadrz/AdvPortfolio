    ...
    <div ref={ref} id="contact" className="w-full container py-32">
      ...
      <div className="flex items-center justify-around w-full h-full">
        <div className="hidden lg:flex flex-col items-center gap-2 text-center max-w-[400px]">
          <h1 className="text-gradient-primary text-4xl">Have a Quick Question?</h1>
          <p className="text-muted-foreground mb-6">{"// "}chat with my AI assistant</p>
          <AIChatBot />
        </div>

        <div className="hidden lg:flex flex-col items-center gap-2 text-center max-w-[400px]">
        <h1 className="text-gradient-primary text-4xl">Have a Quick Question?</h1>
        <p className="text-muted-foreground mb-6">{"// "}Send me a message</p>
